...
"""
lernito-openedx documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'lernito-openedx',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edSPIRIT/lernito-openedx",
...
#
# html_title = 'lernito-openedx v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Webhooks to integrate with Lernito service',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'lernito_openedx'),
                os.path.join(root_path, 'lernito_openedx/migrations')])
