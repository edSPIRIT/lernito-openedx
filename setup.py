#!/usr/bin/env python
"""
Package metadata for lernito_openedx.
"""
import os
import re
import sys
...
VERSION = get_version('lernito_openedx', '__init__.py')
...
setup(
    name='lernito-openedx',
    version=VERSION,
    description="""Webhooks to integrate with Lernito service""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Emad Rad',
    author_email='codewithemad@gmail.com',
    url='https://github.com/edSPIRIT/lernito-openedx',
    packages=find_packages(
        include=['lernito_openedx', 'lernito_openedx.*'],
        exclude=["*tests"],
    ),

    include_package_data=True,
    install_requires=load_requirements('requirements/base.in') + ['djangorestframework'],
    python_requires=">=3.8",
    license="AGPL 3.0",
    zip_safe=False,
    keywords='Python edx',
    ...
    entry_points={
        "lms.djangoapp": [
            "lernito_openedx = lernito_openedx.apps:LernitoOpenedxConfig",
        ],
        "cms.djangoapp": [
            "lernito_openedx = lernito_openedx.apps:LernitoOpenedxConfig",
        ],
